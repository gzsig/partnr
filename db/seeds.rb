...
3.times do
  ...
  Good.create(brand: "Lamborgini", model: "Aventador", model_year: 2014, fabrication_year: 2015, chassis: "12345tfdsadfg", licens_plate: "EIK-1111", kilometers: "8000", price: "1500000", color: "perola", facts: "Esse carro eh foda!", version: "v12", good_type: 'car', photo_one: seed_image('carousel1'), photo_two: seed_image('carousel2'), photo_three: seed_image('carousel3'), photo_four: seed_image('carousel4'), video: seed_video('carousel-video'))
end
puts "done!"
