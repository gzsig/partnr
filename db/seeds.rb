...
puts "done!"
  ...
  puts "creating 1 (car)..."
  Good.create(brand: ["Lamborgini"].sample, model: "Aventador", model_year: 2014, fabrication_year: [2018].sample, body_style: ['sport'].sample, serial_number: "76FGBS3N29W", licens_plate: "EIK-1111", kilometers: "900", price: ["4700000"].sample, color: ["branco"].sample, facts: "MSRP: From CR$4.7 million \n Max speed: 350 km/h \n Horsepower: 700 to 740 hp \n Dimensions: 4,780-4,797 mm L x 2,030 mm W x 1,136 mm H \n Acceleration 0-100 km/h: 2.9 to 3 seconds \n Fuel tank capacity: 85 to 90 L", version: "v12", good_type: ['Carro'].sample, photo_one: seed_image('carousel1'), photo_two: seed_image('carousel2'), photo_three: seed_image('carousel3'), photo_four: seed_image('carousel4'), video: seed_video('carousel-video') )
  Good.create(brand: ["Volvo"].sample, model: "XC-40", model_year: 2014, fabrication_year: [2010].sample, body_style: ['sport'].sample, serial_number: "76FGBS3N29W", licens_plate: "EIK-1111", kilometers: "0", price: ["1500000"].sample, color: ["branco"].sample, facts: "MSRP: From CR$4.7 million \n Max speed: 350 km/h \n Horsepower: 700 to 740 hp \n Dimensions: 4,780-4,797 mm L x 2,030 mm W x 1,136 mm H \n Acceleration 0-100 km/h: 2.9 to 3 seconds \n Fuel tank capacity: 85 to 90 L", version: "v12", good_type: ['Carro'].sample, photo_one: seed_image('carousel1'), photo_two: seed_image('carousel2'), photo_three: seed_image('carousel3'), photo_four: seed_image('carousel4'), video: seed_video('carousel-video') )
  Good.create(brand: ["Audi"].sample, model: "A8", model_year: 2014, fabrication_year: [2012].sample, body_style: ['sport'].sample, serial_number: "76FGBS3N29W", licens_plate: "EIK-1111", kilometers: "2000", price: ["900000"].sample, color: ["branco"].sample, facts: "MSRP: From CR$4.7 million \n Max speed: 350 km/h \n Horsepower: 700 to 740 hp \n Dimensions: 4,780-4,797 mm L x 2,030 mm W x 1,136 mm H \n Acceleration 0-100 km/h: 2.9 to 3 seconds \n Fuel tank capacity: 85 to 90 L", version: "v12", good_type: ['Carro'].sample, photo_one: seed_image('carousel1'), photo_two: seed_image('carousel2'), photo_three: seed_image('carousel3'), photo_four: seed_image('carousel4'), video: seed_video('carousel-video') )
